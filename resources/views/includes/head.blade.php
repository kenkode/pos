...
<link rel="shortcut icon" href="{{asset('public/uploads/pos.jpg')}}">
  ...
  <link href="{{asset('public/src/facebox.css')}}" media="screen" rel="stylesheet" type="text/css" />
  <link href="{{asset('public/js/tcal.css')}}" media="screen" rel="stylesheet" type="text/css" />
